...
describe("extensions page tests", () => {
  ...
  const extensions = process.env.EXTENSION_PATH
    ...
    : [
        "@kubesightapp/example-extension",
        "@kubesightapp/example-extension@1.3.0",
        "@kubesightapp/extension-example@1.2.0",
        "@kubesightapp/extension-example@1.0.0",
        "@kubesightapp/k8sight-node-pod-menu",
        "@kubesightapp/k8sight-node-pod-menu@1.1.0",
        "@kubesightapp/k8sight-node-pod-menu@1.0.0",
      ];
