...
export default function generateExtensionTypes(): webpack.Configuration {
  return {
    ...
    output: {
      ...
      // e.g. require('@kubesightapp/extensions')
    ...
    externals: ["@kubesightapp/core/common", "@kubesightapp/core/main", "@kubesightapp/core/renderer"],
    module: {
      rules: [
        {
          test: /\.node$/,
        ...
        },
        {
          ...
          options: {
            ...
            // !! on '@kubesightapp/extensions' module
            compilerOptions: {
