...
const NonInjectedLiveFrames = observer(({ state }: Dependencies) => (
  <section className="small">
    ...
    <small className="hint">
      How many dashboard tabs keep a running cluster view in memory. Each one is a full renderer with
      its own watches, so a lower number saves memory; tabs past the limit stay in the strip and
      reload, on the page they were showing, when you come back to them.
    </small>
  </section>
));
