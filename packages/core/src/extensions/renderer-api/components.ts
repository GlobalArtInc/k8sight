import { asLegacyGlobalForExtensionApi, asLegacyGlobalFunctionForExtensionApi } from "@kubesightapp/legacy-global-di";
import {
...
} from "@kubesightapp/notifications";
...
export * from "@kubesightapp/button";
export * from "@kubesightapp/icon";
export {
...
export * from "@kubesightapp/spinner";
export * from "@kubesightapp/tooltip";
