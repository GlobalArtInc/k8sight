...
import navigateForExtensionInjectable from "../main/start-main-application/k8sight-window/navigate-for-extension.injectable";
...
import { K8sightExtension } from "./k8sight-extension";
...
import type { NavigateForExtension } from "../main/start-main-application/k8sight-window/navigate-for-extension.injectable";
import type { TrayMenuRegistration } from "../main/tray/tray-menu-registration";
import type { InstalledExtension } from "./common-api";
import type { K8sightExtensionDependencies } from "./k8sight-extension";

interface K8sightMainExtensionDependencies extends K8sightExtensionDependencies {
  readonly entityRegistry: CatalogEntityRegistry;
  readonly navigate: NavigateForExtension;
}

export class K8sightMainExtension extends K8sightExtension {
   ...
   * @ignore
   */
  declare readonly dependencies: K8sightMainExtensionDependencies;

  constructor(extension: InstalledExtension) {
    const di = getEnvironmentSpecificLegacyGlobalDiForExtensionApi("main");
    const deps: K8sightMainExtensionDependencies = {
  ...
  /**
   * implement this to modify the shell environment that K8sight terminals are opened with. The ShellEnvModifier type has the signature
   *
