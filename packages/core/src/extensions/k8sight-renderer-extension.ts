...
import { Disposers, K8sightExtension } from "./k8sight-extension";

import type { ClusterFrameChildComponent } from "@kubesightapp/react-application";
...
interface K8sightRendererExtensionDependencies extends K8sightExtensionDependencies {
...
export class K8sightRendererExtension extends K8sightExtension {
   ...
   * @ignore
   */
  protected declare readonly dependencies: K8sightRendererExtensionDependencies;

  constructor(extension: InstalledExtension) {
    const di = getEnvironmentSpecificLegacyGlobalDiForExtensionApi("renderer");
    const deps: K8sightRendererExtensionDependencies = {
