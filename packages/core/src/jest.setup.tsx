import k8sightFetch from "@kubesightapp/node-fetch";
...
global.fetch = k8sightFetch as unknown as typeof fetch;
...
jest.mock("@kubesightapp/tooltip", () => ({
  ...jest.requireActual("@kubesightapp/tooltip"),
  withTooltip: ((Target) =>
