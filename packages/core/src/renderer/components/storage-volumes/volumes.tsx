...
import { persistentVolumeClaimApiInjectable, storageClassApiInjectable } from "@kubesightapp/kube-api-specifics";
...
import type { PersistentVolumeClaimApi, StorageClassApi } from "@kubesightapp/kube-api";
