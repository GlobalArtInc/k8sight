import { cpuUnitsToNumber, unitsToBytes } from "@kubesightapp/utilities/dist";
import autoBind from "auto-bind";
import { sum } from "lodash";
import { computed, makeObservable, observable } from "mobx";
import { KubeObjectStore } from "../../../common/k8s-api/kube-object.store";

import type { NodeApi, NodeMetricsApi } from "@kubesightapp/kube-api";
import type { Node, NodeMetrics } from "@kubesightapp/kube-object";
