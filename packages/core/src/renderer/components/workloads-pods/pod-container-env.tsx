...
import { cpuUnitsToNumber, metricUnitsToNumber, object, unitsToBytes } from "@kubesightapp/utilities";
...
import type { Container, Pod, ResourceRequirements } from "@kubesightapp/kube-object";
