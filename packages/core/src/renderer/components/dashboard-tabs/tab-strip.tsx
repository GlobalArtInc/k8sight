...
const NonInjectedTabStrip = observer(
  ({ tabsStore, entityRegistry, navigateToClusterView, navigateToCatalog }: Dependencies) => {
          ...
          {tabs.map((tab, index) => {
            ...
            return (
              ...
              >
                ...
                <span className={styles.label}>{tab.title ? `${tab.title} - ${clusterName}` : clusterName}</span>
                <Icon
                  material="close"
                  small
