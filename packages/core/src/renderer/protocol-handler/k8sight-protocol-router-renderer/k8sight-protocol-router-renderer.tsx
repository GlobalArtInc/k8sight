...
import type { K8sightProtocolRouterDependencies } from "../../../common/protocol-handler";

interface Dependencies extends K8sightProtocolRouterDependencies {
  showShortInfoNotification: ShowNotification;
  showErrorNotification: ShowNotification;
}

export class K8sightProtocolRouterRenderer extends proto.K8sightProtocolRouter {
