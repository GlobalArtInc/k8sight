...
export const getK8sightLikeQueryFor =
...
const k8sightPrometheusProviderInjectable = getInjectable({
  id: "k8sight-prometheus-provider",
  instantiate: () =>
    createPrometheusProvider({
      kind: "k8sight",
      name: "K8sight",
      isConfigurable: false,
      getQuery: getK8sightLikeQueryFor({ rateAccuracy: "1m" }),
      getService: (client) => findNamespacedService(client, "prometheus", "k8sight-metrics"),
    }),
  injectionToken: prometheusProviderInjectionToken,
});

export default k8sightPrometheusProviderInjectable;
