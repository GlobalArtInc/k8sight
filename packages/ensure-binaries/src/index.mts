...
class K8SightK8sProxyDownloader extends BinaryDownloader {
  ...
  constructor(args: Omit<BinaryDownloaderArgs, "binaryName" | "url">, bar: MultiBar) {
    ...
    const binaryName = "k8sight-k8s-proxy" + binaryExtension;
    const url = `https://github.com/GlobalArtInc/k8sight-k8s-proxy/releases/download/v${args.version}/k8sight-k8s-proxy-${args.platform}-${args.downloadArch}${binaryExtension}`;
