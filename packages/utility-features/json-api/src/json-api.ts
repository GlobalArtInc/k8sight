...
import { isObject, isString, json } from "@kubesightapp/utilities";
...
import type Fetch from "@kubesightapp/node-fetch";
import type { RequestInit, Response } from "@kubesightapp/node-fetch";
import type { Defaulted } from "@kubesightapp/utilities";
