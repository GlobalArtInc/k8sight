...
```javascript
module.exports = require("@kubesightapp/jest").monorepoPackageConfig(__dirname).configForNode;
```
...
**./packages/any-package/jest.config.js**
```javascript
module.exports = require("@kubesightapp/jest").monorepoPackageConfig(__dirname).configForReact;
```
...
**./jest.config.js**
```javascript
module.exports = require("@kubesightapp/jest").monorepoRootConfig(__dirname);
```
